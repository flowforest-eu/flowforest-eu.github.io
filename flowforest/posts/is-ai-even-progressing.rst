...
super-human levels on those evaluations (sometimes through real general progress, sometimes through training for exactly 
those evaluations).

In order to have a peace of mind and see the broader picture, one must zoom out - ideally far enough to see the whole timeline 
since first LLMs onwards to now. This is exactly what METR (a non-profit research institute in California) has done.
+++
...
Next post will touch upon this topic:
- why is AI already super-human in some aspects, and embarassingly weak in others? How is that going to change in 
the future?
